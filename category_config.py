...
CATEGORIES: dict = {
    ...
    "camping": CategoryConfig(
        ...
        fallback_keywords=[
            # ── 텐트 / 쉘터 ──
            "best 2 person backpacking tent under 3 lbs",
            "best 4 season tent for winter camping",
            "best tarp shelter for ultralight backpacking",
            "best tent for high winds and rain",
            "best solo backpacking tent under 200 dollars",
            # ── 침낭 / 매트 ──
            "best sleeping bag for side sleepers",
            "best sleeping bag for cold weather camping under 100",
            "best ultralight sleeping pad for backpacking",
            "best sleeping pad for bad back camping",
            # ── 쿠킹 ──
            "best camp stove for high altitude cooking",
            "best backpacking cookware set for 2 people",
            "best camping coffee maker lightweight",
            # ── 의자 / 테이블 ──
            "best camping chair for bad backs",
            "best ultralight camp chair under 2 lbs",
            "best folding camping table for car camping",
            # ── 수분 / 정수 ──
            "best water filter for backpacking under 50 dollars",
            "best gravity water filter for base camp",
            "best collapsible water bottle for hiking",
            # ── 조명 ──
            "best rechargeable headlamp for hiking 2026",
            "best solar camping lantern for long trips",
            # ── 의류 / 레이어링 ──
            "best rain jacket for hiking under 200 dollars",
            "best base layer for winter hiking",
            "best down jacket ultralight for backpacking",
            "best hiking pants for hot weather",
            # ── 신발 / 폴 ──
            "best hiking boots for wide feet waterproof",
            "best trekking poles for bad knees lightweight",
            "best trail running shoes for rocky terrain",
            # ── 배낭 ──
            "best backpacking pack for beginners 50 liter",
            "best daypack for hiking 20 liter",
            # ── 안전 / 기타 ──
            "best bear canister for PCT through hike",
            "best satellite communicator for solo hiking",
            "best camping first aid kit for backpacking",
            "best multi tool for camping lightweight",
            "best camping hammock with bug net under 100",
        ],
